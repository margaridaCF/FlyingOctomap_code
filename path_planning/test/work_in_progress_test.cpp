...
namespace LazyThetaStarOctree
{
		...
		int const& max_search_iterations = 55)
	{
		...
		std::list<octomath::Vector3> resulting_path = lazyThetaStar_(octree, disc_initial, disc_final, statistical_data, safety_margin, sidelength_lookup_table, filter_sparse, marker_pub, max_search_iterations, true, true);
		// NO PATH
