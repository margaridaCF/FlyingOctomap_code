...
{	
    bool equal (const geometry_msgs::Point & a, const geometry_msgs::Point & b, 
 	...
 	void runAndWriteCSV(lazy_theta_star_msgs::LTStarRequest request, octomap::OcTree & octree, PublishingInput publish_input, std::string distance_label, double distance_meters, std::string csv_file_name)
 	{
