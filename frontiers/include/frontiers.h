...
namespace Frontiers{
    ...
    bool meetsOperationalRequirements(double voxel_size, octomath::Vector3 const&  candidate, double min_distance, octomath::Vector3 const& current_position, octomap::OcTree const& octree, double safety_margin, ros::Publisher const& marker_pub, bool publish = true);
